...
uk_const_2021 <- readRDS(here("data", "processed", "uk_constituencies_2021_simplified.rds"))
...
# Load constituency boundaries
uk_const_2024 <- readRDS(here("data", "processed", "uk_constituencies_2024_simplified.rds"))
uk_const <- uk_const_2024
