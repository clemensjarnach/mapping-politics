...
This repository contains the source files for **Elections Visualised**, a teaching and research project examining the geography of voting in UK General Elections from 2010 to 2024. It demonstrates how to **acquire, clean, analyse, and visualise geospatial and electoral data in R**, with a focus on transparent and reproducible workflows.
...
**Work in Progress** Additional chapters — including **Spatial Regression** and advanced geospatial exercises — will be added soon.
